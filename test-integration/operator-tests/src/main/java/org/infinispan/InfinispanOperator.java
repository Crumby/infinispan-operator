...
public class InfinispanOperator {
    ...
    public InfinispanOperator() {
        this.openShift = OpenShifts.master(InfinispanOperatorConfig.namespace());

        this.name = InfinispanOperatorConfig.name();
        this.channel = InfinispanOperatorConfig.channel();
        this.installPlanApproval = InfinispanOperatorConfig.approval();
        this.source = InfinispanOperatorConfig.source();
        this.sourceNamespace = InfinispanOperatorConfig.sourceNamespace();
        this.startingCSV = InfinispanOperatorConfig.version();
    }
    ...
    public InfinispanOperator(String channel, String approval, String source) {
        this.openShift = OpenShifts.master(SuiteConfig.globalOperatorsNamespace());
    ...
    public InfinispanOperator(String channel, String approval, String source, String startingCSV) {
        this.openShift = OpenShifts.master(SuiteConfig.globalOperatorsNamespace());
    ...
    public Waiter isUpgradeReadyWaiter() {
        return new SimpleWaiter(this::isUpgradeReady);
    }
