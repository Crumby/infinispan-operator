...
public class MicroUpgradeIT {
    ...
    private static String sourceCSVVersion;
    ...
    static void prepare() throws Exception {
        ...
        operator = new InfinispanOperator(sourceChannel, "Manual", devCatalog, sourceCSVVersion);
    ...
    private static void initChannels() {
        ...
        sourceCSVVersion = getCurrentCSV(releasedPM, sourceChannel);
    }
